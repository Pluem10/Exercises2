...
const student1 = new Student("Nitiphon","13 หนองปากโรง อ.เมือง 73000", "Software Engineer", 2, 11400);
console.log(student1.toString());

// console.log("##################################")

const staff1= new Staff ("Pluem","74/4 ต.นาหูกวาวง อ.ทับสะเเก","NPRU",5000)
